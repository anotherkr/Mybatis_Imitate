...
import com.yhz.mybatis.mapping.SqlCommandType;
...
public class MapperBuilderAssistant extends BaseBuilder{
    ...
    /**
     * 该方法的作用是为 MyBatis 映射器语句中的 ID 属性添加命名空间前缀
     *
     * @param base 要添加命名空间前缀的字符串
